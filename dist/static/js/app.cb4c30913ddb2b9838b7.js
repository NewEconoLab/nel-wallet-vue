            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        dommsg.time = importpack_1.tools.timetool.dateFtt("yyyy-MM-dd hh:mm:ss", new Date(parseInt(msg.ttl + "000")));
...
var DateTool = /** @class */ (function () {
    ...
    DateTool.wattingState = function (a) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (a > 3) {
                    return [2 /*return*/, a];
...
var WWW = /** @class */ (function () {
     ...
     * @param pagesize 条数
     */
    WWW.api_getBidDetail = function (domain, currentpage, pagesize) {
        return __awaiter(this, void 0, void 0, function () {
            var postdata, result, json, r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        postdata = WWW.makeRpcPostBody("getbiddetailbydomain", domain, currentpage, pagesize);
                        return [4 /*yield*/, fetch(WWW.apiaggr, { "method": "post", "body": JSON.stringify(postdata) })];
                    case 1:
                        result = _a.sent();
                        return [4 /*yield*/, result.json()];
     ...
     * @param domain 域名
     */
    WWW.getDomainState = function (address, domain) {
        return __awaiter(this, void 0, void 0, function () {
            var postdata, result, json, r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        postdata = WWW.makeRpcPostBody("getdomainstate", address, domain);
                        return [4 /*yield*/, fetch(WWW.apiaggr, { "method": "post", "body": JSON.stringify(postdata) })];
                    case 1:
                        result = _a.sent();
                        return [4 /*yield*/, result.json()];
...
var LocalStoreTool = /** @class */ (function () {
    ...
    LocalStoreTool.prototype.set = function (obj) {
        localStorage.setItem(this.table, JSON.stringify(obj));
    };
    /**
     * 查找数据
...
var sessionStoreTool = /** @class */ (function () {
     ...
     * @param value
     */
    sessionStoreTool.prototype.put = function (key, value) {
     ...
     * @param key
     */
    sessionStoreTool.prototype.delete = function (key) {
        var item = sessionStoreTool.getTable(this.table);
        if (item && item[key]) {
            delete item[key];
            localStorage.setItem(this.table, JSON.stringify(item));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-f55f6984","hasScoped":true,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/pages/bid/bonus.vue
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-f55f6984"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  bonus_default.a,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        his.txtype = "in";
                        his["waiting"] = true;
                        his.time = importpack_1.tools.timetool.dateFtt("yyyy-MM-dd hh:mm:ss", new Date());
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 4:
                        ...
                        date = importpack_1.tools.timetool.dateFtt("yyyy-MM-dd hh:mm:ss", new Date(time));
...
var NeoAuction = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        _b = this;
                        return [4 /*yield*/, neoauctionDataModel_1.NeoaucionData.getAssetBalance()];
                    case 3:
                        _b.assetlist = _c.sent();
     ...
     * @param key 资产id
     */
    NeoAuction.prototype.onSelect = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var str;
            return __generator(this, function (_a) {
                str = (key == importpack_1.tools.coinTool.id_GAS ? this.assetlist[key] + " Gas" : this.assetlist[key] + " SGas");
    ...
    NeoAuction.prototype.openTopUp = function () {
        return __awaiter(this, void 0, void 0, function () {
            var gasRecharge, sgasRecharge, txid, amount, txid, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.alert_TopUp.isShow = true;
                        gasRecharge = this.sessionWatting.select("recharge-gas");
                        sgasRecharge = this.sessionWatting.select("recharge-sgas");
                        if (gasRecharge) {
                            txid = gasRecharge["txid"];
                            this.confirmRecharge(txid);
                        }
                        if (!sgasRecharge) return [3 /*break*/, 2];
                        amount = sgasRecharge["amount"];
                        txid = sgasRecharge["txid"];
                        return [4 /*yield*/, importpack_1.tools.wwwtool.getrawtransaction(txid)];
                    case 1:
                        res = _a.sent();
                        if (!res) {
                            this.assetlist[importpack_1.tools.coinTool.id_SGAS.toString()] = -amount;
                        }
                        else {
    ...
    NeoAuction.prototype.openWithdraw = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wat = this.sessionWatting.select("withdraw");
                        this.alert_withdraw.isShow = true;
                        if (!wat) return [3 /*break*/, 2];
                        return [4 /*yield*/, importpack_1.tools.wwwtool.getrawtransaction(wat)];
                    case 1:
                        res = _a.sent();
                        if (!!res) {
     ...
     * @param txid 交易id
     */
    NeoAuction.prototype.withdrawConfirm = function (txid) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var res;
            return __generator(this, function (_a) {
     ...
     * @param domain 域名
     */
    NeoAuction.prototype.bidConfirm = function (txid, domain) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        auction = new entity_1.MyAuction();
                        auction.domain = this.domain + ".neo";
                        auction.startAuctionTime = importpack_1.tools.timetool.dateFtt("yyyy-MM-dd hh:mm:ss", new Date());
                        auction.auctionState = '3';
                        auction.maxPrice = "0";
                        this.myAuctionList.unshift(auction);
                        neoauctionDataModel_1.NeoaucionData.setOpenSession(auction);
                        return [4 /*yield*/, this.openAuction_confirm(res["info"])];
                    case 2:
                        _a.sent();
     ...
     * @param txid 交易id
     */
    NeoAuction.prototype.openAuction_confirm = function (txid) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!!res) {
                            ...
                            setTimeout(function () {
                                _this.openAuction_confirm(txid);
                            }, 5000);
                        }
                        return [2 /*return*/];
                }
    ...
    NeoAuction.prototype.queryDomainState = function () {
        return __awaiter(this, void 0, void 0, function () {
            var info, sellstate, startTime, state;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, importpack_1.tools.nnssell.getSellingStateByDomain(this.domain + ".neo")];
                    case 1:
     ...
     * @param txid 交易id
     */
    NeoAuction.prototype.confirmRecharge = function (txid) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var res, amount;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, importpack_1.tools.wwwtool.getrechargeandtransfer(txid)];
                    case 1:
                        res = _a.sent();
                        if (res['errCode'] == '3003') {
                            this.alert_TopUp.watting = true;
                            amount = this.sessionWatting.select("recharge-gas")["amount"];
                            // this.assetlist[ tools.coinTool.id_GAS ] -= parseFloat(amount);
                            setTimeout(function () {
                                _this.confirmRecharge(txid);
                            }, 5000);
                        }
                        else {
     ...
     * @param txid 交易id
     */
    NeoAuction.prototype.confirmRecharge_sgas = function (txid) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var res;
            return __generator(this, function (_a) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (list.length) {
                            for (i in list) {
                                list[i].blocktime = importpack_1.tools.timetool.dateFtt("yyyy-MM-dd hh:mm:ss", new Date(list[i].blocktime * 1000));
                            }
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-1a909d58","hasScoped":true,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/pages/bid/auctioninfo.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"page-two"},[_c('div',{staticClass:"title"},[_c('span',[_vm._v("Auction Information")]),_vm._v(" "),_c('div',{staticClass:"goback",on:{"click":_vm.onBack}},[_vm._v("<<<Go back")])]),_vm._v(" "),_c('div',{staticClass:"form-box"},[_c('div',{staticClass:"filename"},[_vm._v("Domain : "+_vm._s(_vm.item.domain))]),_vm._v(" "),(_vm.item.auctionState=='Fixed period')?_c('div',{staticClass:"status"},[_vm._v("Status : "),_c('span',{staticClass:"status-being"},[_vm._v("Fixed period")])]):_vm._e(),_vm._v(" "),(_vm.item.auctionState=='Random period')?_c('div',{staticClass:"status"},[_vm._v("Status : "),_c('span',{staticClass:"status-random"},[_vm._v("Random period")])]):_vm._e(),_vm._v(" "),(_vm.item.auctionState=='Ended')?_c('div',{staticClass:"status"},[_vm._v("Status : "),_c('span',{staticClass:"status-ended"},[_vm._v("Ended")])]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"highest-price"},[_vm._v("Highest bid price : "+_vm._s(_vm.item.maxPrice)+" SGas")]),_vm._v(" "),(_vm.item.maxBuyer != _vm.address)?_c('div',{staticClass:"bidder"},[_vm._v("Current bidder  : "),_c('span',[_vm._v("Other people（ "+_vm._s(_vm.item.maxBuyer)+" ）")])]):_vm._e(),_vm._v(" "),(_vm.item.maxBuyer == _vm.address)?_c('div',{staticClass:"bidder"},[_vm._v("Current bidder  : "),_c('span',{staticClass:"bidder-me"},[_vm._v("Me（ "+_vm._s(_vm.item.maxBuyer)+" ）")])]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"my-bid-sgas"},[_vm._v("My cumulative bid  : "),_c('span',{staticClass:"status-ended"},[_vm._v(_vm._s(_vm.item.mybidprice))]),_vm._v("  SGas")])]),_vm._v(" "),(_vm.item.auctionState==0 && _vm.item.maxBuyer == _vm.address)?_c('div',[_vm._m(0,false,false),_vm._v(" "),_c('div',{staticClass:"form-box"},[_c('div',{staticClass:"neoname"},[_vm._v(" "+_vm._s(_vm.item.domain))]),_vm._v(" "),_c('div',{staticClass:"neoname-tips"},[_vm._v("Tips : When you successfully get your domain,You can edit it in My Neo Name.")]),_vm._v(" "),_c('div',{staticClass:"btn-center"},[(_vm.state_getDomain==0)?_c('button',{staticClass:"btn btn-nel btn-bid",on:{"click":_vm.getDomain}},[_vm._v("Get domain")]):_vm._e(),_vm._v(" "),(_vm.state_getDomain==1)?_c('button',{staticClass:"btn btn-nel btn-bid btn-disable",attrs:{"disabled":""}},[_vm._v("Getting domain...")]):_vm._e(),_vm._v(" "),(_vm.state_getDomain==2)?_c('button',{staticClass:"btn btn-nel btn-bid btn-disable",attrs:{"disabled":""}},[_vm._v("Received")]):_vm._e()])])]):_vm._e(),_vm._v(" "),(_vm.item.auctionState==0 && _vm.item.maxBuyer != _vm.address)?_c('div',[_vm._m(1,false,false),_vm._v(" "),_c('div',{staticClass:"form-box"},[_c('div',{staticClass:"cumulative-msg"},[_vm._v("My cumulative bid  : "+_vm._s(_vm.balanceOfSelling)+" SGas")]),_vm._v(" "),_c('div',{staticClass:"fee-msg"},[_vm._v("Fee : "+_vm._s(_vm.fee)+" SGas")]),_vm._v(" "),_c('div',{staticClass:"remain-msg"},[_vm._v("Remaining SGas : "+_vm._s(_vm.remaining)+" SGas")]),_vm._v(" "),_c('div',{staticClass:"btn-center"},[(_vm.state_recover==0)?_c('button',{staticClass:"btn btn-nel btn-bid",on:{"click":_vm.recoverSgas}},[_vm._v("Recover SGas")]):_vm._e(),_vm._v(" "),(_vm.state_recover==1)?_c('button',{staticClass:"btn btn-nel btn-bid btn-disable",attrs:{"disabled":""}},[_vm._v("Recovering SGas...")]):_vm._e(),_vm._v(" "),(_vm.state_recover==2)?_c('button',{staticClass:"btn btn-nel btn-bid btn-disable",attrs:{"disabled":""}},[_vm._v("Received")]):_vm._e()])])]):_vm._e(),_vm._v(" "),(_vm.item.auctionState>0)?_c('div',[_vm._m(2,false,false),_vm._v(" "),_c('div',{staticClass:"form-box"},[_c('div',[_c('div',{staticClass:"input-msg"},[_vm._v("Raise my bid : ")]),_vm._v(" "),_c('div',{staticClass:"input-box"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.myBidPrice),expression:"myBidPrice"}],attrs:{"type":"number","placeholder":"Enter a raise"},domProps:{"value":(_vm.myBidPrice)},on:{"input":[function($event){if($event.target.composing){ return; }_vm.myBidPrice=$event.target.value},_vm.myBidInput]}}),_vm._v(" "),_c('span',[_vm._v("SGas")])]),_vm._v(" "),_c('div',{staticClass:"err-msg status-ended"},[_vm._v("Only "+_vm._s(_vm.balanceOf)+" SGas is available.")])]),_vm._v(" "),_c('div',{staticClass:"my-sgas"},[_vm._v("My cumulative bid will be : "),_c('span',{staticClass:"status-ended"},[_vm._v(_vm._s(_vm.updatePrice))]),_vm._v(" SGas")]),_vm._v(" "),_c('div',{staticClass:"tips-msg"},[_vm._v("\n            Tips : The minimum value for your raise is 0.1 SGas. When your cumulative bid is less than the  highest bid price, The raise will be unsuccessful. \n        ")]),_vm._v(" "),_c('div',{staticClass:"btn-bid-box"},[(_vm.bidState==2)?_c('button',{staticClass:"btn btn-bid btn-disable",attrs:{"disabled":"disabled"}},[_vm._v("Bid")]):_vm._e(),_vm._v(" "),(_vm.bidState==1)?_c('button',{staticClass:"btn btn-nel btn-bid btn-disable",attrs:{"disabled":""}},[_vm._v("Bid...")]):_vm._e(),_vm._v(" "),(_vm.bidState==0)?_c('button',{staticClass:"btn btn-bid ",on:{"click":_vm.bidDomain}},[_vm._v("Bid")]):_vm._e()])])]):_vm._e(),_vm._v(" "),_vm._m(3,false,false),_vm._v(" "),_c('div',{staticClass:"form-box"},[_c('div',{staticClass:"process-wrapper"},[_c('label',[_vm._v("Status")]),_vm._v(" "),_c('div',{staticClass:"process-box"},[_c('div',{staticClass:"process long",style:('width:'+_vm.width+'%')},[_c('div',{staticClass:"process-tips"},[_vm._v(_vm._s(_vm.process_state)+" ")])]),_vm._v(" "),_c('div',{staticClass:"starts"},[_vm._v(_vm._s(_vm.process_date)+"\n            "),_c('br'),_vm._v(_vm._s(_vm.process_time))]),_vm._v(" "),_vm._l((_vm.process_arr),function(days){return _c('div',{key:days.msg,staticClass:"days"},[(days.msg!='')?_c('em',[_vm._v(_vm._s(days.msg))]):_vm._e(),_vm._v(" "),_c('span',[_vm._v(_vm._s(days.date)+"\n              "),_c('br'),_vm._v(_vm._s(days.time))])])})],2)]),_vm._v(" "),_c('div',{staticClass:"auction-tips"},[_vm._v("Tips : The auction is about going to random period, and it may end at any point during the random period.")]),_vm._v(" "),_c('div',{staticClass:"timeling-wrapper"},[_c('div',{staticClass:"first"}),_vm._v(" "),_vm._l((_vm.bidDetailList),function(item,index){return _c('div',{key:index,staticClass:"list"},[_c('div',{staticClass:"line"}),_vm._v(" "),_c('div',{staticClass:"infos"},[_c('span',[_vm._v(_vm._s(item.addPriceTime))]),_vm._v(" "),(!item.maxBuyer)?_c('p',[_vm._v("Auction Opened")]):_vm._e(),_vm._v(" "),(item.maxBuyer != _vm.address && item.maxBuyer)?_c('p',{staticStyle:{"font-size":"12px"}},[_vm._v("Other people（ "),_c('span',{staticStyle:{"font-size":"12px"}},[_vm._v(_vm._s(item.maxBuyer))]),_vm._v("  ）")]):_vm._e(),_vm._v(" "),(item.maxBuyer == _vm.address)?_c('p',{staticClass:"bidder-me"},[_vm._v("Me（ "),_c('span',[_vm._v(_vm._s(item.maxBuyer))]),_vm._v(" ）")]):_vm._e(),_vm._v(" "),(item.maxBuyer!='')?_c('em',[_vm._v("Price："+_vm._s(item.maxPrice)+" SGas")]):_vm._e()])])})],2),_vm._v(" "),_c('div',{staticClass:"viewmore"},[(_vm.btnShowmore)?_c('button',{staticClass:"btn btn-nel",on:{"click":_vm.getMoreBidDetail}},[_vm._v("View more")]):_vm._e()])]),_vm._v(" "),_c('v-toast',{ref:"toast"})],1)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"title"},[_c('span',[_vm._v("Get my domain")])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"title"},[_c('span',[_vm._v("Recover SGas")])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"title"},[_c('span',[_vm._v("Raise my bid")])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"title"},[_c('span',[_vm._v("Timeline")])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var bid_auctioninfo = (esExports);
// CONCATENATED MODULE: ./src/pages/bid/auctioninfo.vue
function injectStyle (ssrContext) {
  __webpack_require__("+nhb")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
/* template */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-1a909d58"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        ...
                        _c.label = 8;
                    case 8:
                        list[i]["ttl"] = importpack_1.tools.timetool.dateFtt("yyyy/MM/dd hh:mm:ss", new Date(res[i]["ttl"] * 1000));
                        _c.label = 9;
                    case 9:
                        _i++;
                        return [3 /*break*/, 2];
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-31d4c1a1","hasScoped":true,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/pages/nns/nns.vue
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-31d4c1a1"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  nns_default.a,
...
var NeoaucionData = /** @class */ (function () {
    ...
    NeoaucionData.getBidList = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var res, arr, obj, list, _a, _b, _i, i, element, balanceOfSelling, current, _c, _d, _e, key, element, info, bidSession, bidlist, _f, _g, _h, key_1, element_1, res_1;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0: return [4 /*yield*/, importpack_1.tools.wwwtool.api_getBidListByAddress(address)];
                    case 1:
                        res = _j.sent();
                        arr = new Array();
                    ...
                    case 2:
                        ...
                        i = _a[_i];
                        element = list[i];
                        return [4 /*yield*/, importpack_1.tools.nnssell.getBalanceOfSeling(Neo.Uint256.parse(element.id.replace('0x', '')))];
                    case 3:
                        balanceOfSelling = _j.sent();
                        ...
                        //开始时间日期格式化
                        element.startAuctionTime = importpack_1.tools.timetool.dateFtt("yyyy/MM/dd hh:mm:ss", new Date(element.startAuctionTime * 1000));
                    ...
                    case 6:
                        ...
                        key = _c[_e];
                        if (!obj.hasOwnProperty(key)) return [3 /*break*/, 13];
                        element = obj[key];
                    ...
                    case 7:
                        ...
                        bidSession = new importpack_1.tools.localstoretool("bidInfo-" + element.domain);
                        bidlist = bidSession.getList();
                        if (!bidlist) return [3 /*break*/, 12];
                        _f = [];
                        for (_g in bidlist)
                            _f.push(_g);
                        _h = 0;
                    ...
                    case 8:
                        ...
                        key_1 = _f[_h];
                        if (!bidlist.hasOwnProperty(key_1)) return [3 /*break*/, 10];
    ...
    NeoaucionData.session_open = new importpack_1.tools.localstoretool("auction-openSession");
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-94ebd6c0","hasScoped":true,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/pages/bid/neoauction.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"box-warp"},[(!_vm.auctionPage)?_c('div',{staticClass:"page-one"},[_c('div',{staticClass:"tips-box"},[_vm._v("\n          "+_vm._s(_vm.$t('auction.tipsmsg1'))),_c('br'),_vm._v(" "),_c('ol',[_c('li',[_vm._v(_vm._s(_vm.$t('auction.tipsmsg2')))]),_vm._v(" "),_c('li',[_vm._v(_vm._s(_vm.$t('auction.tipsmsg3')))])])]),_vm._v(" "),_c('div',{staticClass:"title"},[_c('span',[_vm._v(_vm._s(_vm.$t('auction.titleaccount')))])]),_vm._v(" "),_c('div',{staticClass:"form-box pall"},[_c('div',{staticClass:"msg-list"},[_c('div',{staticClass:"sgas-count"},[_c('span',[_vm._v("SGas")]),_c('span',{staticClass:"num"},[_vm._v(" "+_vm._s(_vm.regBalance))])])]),_vm._v(" "),_c('div',{staticClass:"btn-right"},[_c('button',{staticClass:"btn btn-nel btn-big",on:{"click":_vm.openWithdraw}},[_vm._v(_vm._s(_vm.$t('btn.withdraw')))]),_vm._v(" "),_c('button',{staticClass:"btn btn-nel btn-big",on:{"click":_vm.openTopUp}},[_vm._v(_vm._s(_vm.$t('btn.topup')))])])]),_vm._v(" "),_c('div',{staticClass:"title"},[_c('span',[_vm._v(_vm._s(_vm.$t('auction.title1')))])]),_vm._v(" "),_c('div',{staticClass:"form-box ptop"},[_c('div',{staticClass:"input-box"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.domain),expression:"domain"}],attrs:{"type":"text","placeholder":_vm.$t('auction.entername')},domProps:{"value":(_vm.domain)},on:{"input":[function($event){if($event.target.composing){ return; }_vm.domain=$event.target.value},_vm.queryDomainState]}}),_vm._v(" "),_c('span',[_vm._v(".neo")])]),_vm._v(" "),(_vm.btn_start==0)?_c('spinner-wrap',{staticStyle:{"margin-left":"20px"}}):_vm._e(),_vm._v(" "),(_vm.btn_start==1)?_c('button',{staticClass:"btn btn-nel btn-big",on:{"click":_vm.openAuction}},[_vm._v(_vm._s(_vm.$t('btn.openauction')))]):_vm._e(),_vm._v(" "),(_vm.btn_start==2)?_c('button',{staticClass:"btn btn-nel btn-big",on:{"click":_vm.addBid}},[_vm._v(_vm._s(_vm.$t('btn.newbid')))]):_vm._e(),_vm._v(" "),(_vm.btn_start==3)?_c('button',{staticClass:"btn btn-nel btn-big btn-disable",attrs:{"disabled":"disabled"}},[_vm._v(_vm._s(_vm.$t('btn.newbid')))]):_vm._e(),_vm._v(" "),_c('span',{staticClass:"waiting-msg"},[_vm._v(_vm._s(_vm.$t('auction.sendingmsg')))]),_vm._v(" "),_c('div',{staticClass:"msg-box"},[_c('img',{attrs:{"src":__webpack_require__("wtuE"),"alt":""}}),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('auction.checkavailable')))]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('auction.checkbeing')))])]),_vm._v(" "),_c('div',{staticClass:"msg-box status-ended"},[_c('span',[_vm._v(_vm._s(_vm.$t('auction.checkformat')))]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('auction.checkbuyer')))])])],1),_vm._v(" "),_c('div',{staticClass:"title"},[_c('span',[_vm._v(_vm._s(_vm.$t('auction.title2')))]),_vm._v(" "),_c('div',{staticClass:"seach-box"},[_c('input',{attrs:{"type":"search","name":"","id":"","placeholder":_vm.$t('auction.searchmsg')}}),_vm._v(" "),_c('img',{attrs:{"src":__webpack_require__("zH9E"),"alt":""}})])]),_vm._v(" "),_vm._l((_vm.myAuctionList),function(item,index){return (_vm.myAuctionList)?_c('div',{key:index,staticClass:"form-box mbottom"},[_c('div',{staticClass:"msg-list"},[_c('div',{staticClass:"msg-neoname"},[_vm._v("\n                    "+_vm._s(item.domain)+"\n                ")]),_vm._v(" "),(item.auctionState==1)?_c('div',{staticClass:"msg-status"},[_vm._v("\n                    "+_vm._s(_vm.$t('auction.status'))+" : "),_c('span',{staticClass:"status-being"},[_vm._v(_vm._s(_vm.$t('auction.fixedperiod')))])]):_vm._e(),_vm._v(" "),(item.auctionState==2)?_c('div',{staticClass:"msg-status"},[_vm._v("\n                    "+_vm._s(_vm.$t('auction.status'))+" : "),_c('span',{staticClass:"status-random"},[_vm._v(_vm._s(_vm.$t('auction.randomperiod')))])]):_vm._e(),_vm._v(" "),(item.auctionState==3)?_c('div',{staticClass:"msg-status"},[_vm._v("\n                    "+_vm._s(_vm.$t('auction.status'))+" : "),_c('span',{staticClass:"status-random"},[_vm._v(_vm._s(_vm.$t('auction.waiting')))])]):_vm._e(),_vm._v(" "),(item.auctionState==0)?_c('div',{staticClass:"msg-status"},[_vm._v("\n                    "+_vm._s(_vm.$t('auction.status'))+" : "),_c('span',{staticClass:"status-ended"},[_vm._v(_vm._s(_vm.$t('auction.ended')))])]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"msg-price"},[_vm._v("\n                    "+_vm._s(_vm.$t('auction.lastauctionprice'))+" : "),_c('span',[_vm._v(_vm._s(item.maxPrice))]),_vm._v(" SGas\n                ")]),_vm._v(" "),(item.maxBuyer != _vm.address)?_c('div',{staticClass:"msg-bidder"},[_vm._v("\n                    "+_vm._s(item.auctionState>0?_vm.$t('auction.currentbidder'):_vm.$t('auction.buyer'))+" : "),_c('span',[_vm._v(_vm._s(_vm.$t('auction.other'))+" （ "+_vm._s(item.maxBuyer)+" ）")])]):_vm._e(),_vm._v(" "),(item.maxBuyer == _vm.address)?_c('div',{staticClass:"msg-bidder"},[_vm._v("\n                    "+_vm._s(item.auctionState>0?_vm.$t('auction.currentbidder'):_vm.$t('auction.buyer'))+"  : "),_c('span',{staticClass:"bidder-me"},[_vm._v(_vm._s(_vm.$t('auction.me'))+" （ "+_vm._s(_vm.address)+" ）")])]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"msg-time"},[_vm._v("\n                    "+_vm._s(_vm.$t('auction.bidstarttimemsg'))+" : "),_c('span',[_vm._v(_vm._s(item.startAuctionTime))])]),_vm._v(" "),_vm._l((item.bidListSession),function(value,key){return (item.bidListSession)?_c('div',{key:key},[_vm._v("\n                  "+_vm._s(value)+"\n                ")]):_vm._e()})],2),_vm._v(" "),_c('div',{staticClass:"btn-right"},[(item.auctionState=='1'||item.auctionState=='2')?_c('button',{staticClass:"btn btn-nel btn-bid",on:{"click":function($event){_vm.onGoBidInfo(item)}}},[_vm._v(_vm._s(_vm.$t('btn.bid')))]):_vm._e(),_vm._v(" "),(item.auctionState=='0' && item.maxBuyer==_vm.address && item.receivedState==0)?_c('button',{staticClass:"btn btn-nel btn-bid",on:{"click":function($event){_vm.onGoBidInfo(item)}}},[_vm._v(_vm._s(_vm.$t('btn.getdomain')))]):_vm._e(),_vm._v(" "),(item.auctionState=='0' && item.maxBuyer!=_vm.address && item.receivedState==0)?_c('button',{staticClass:"btn btn-nel btn-bid",on:{"click":function($event){_vm.onGoBidInfo(item)}}},[_vm._v(_vm._s(_vm.$t('btn.recoversgas')))]):_vm._e(),_vm._v(" "),(item.auctionState=='0' && item.receivedState>0)?_c('button',{staticClass:"btn btn-nel btn-bid",on:{"click":function($event){_vm.onGoBidInfo(item)}}},[_vm._v(_vm._s(_vm.$t('btn.received')))]):_vm._e()])]):_vm._e()})],2):_vm._e(),_vm._v(" "),(_vm.auctionPage)?_c('auction-info',{attrs:{"item":_vm.domainInfo},on:{"onBack":_vm.onBack}}):_vm._e(),_vm._v(" "),(_vm.auctionShow)?_c('div',{staticClass:"auction-wrap"},[_c('div',{staticClass:"auction-box"},[_c('div',{staticClass:"auction-title"},[_vm._v(_vm._s(_vm.$t('auction.acutiontitle')))]),_vm._v(" "),_c('div',{staticClass:"wrap-msg"},[_c('div',{staticClass:"domain-name"},[_vm._v(_vm._s(_vm.$t('auction.domain'))+" : "+_vm._s(_vm.auctionMsg_alert.domain))]),_vm._v(" "),_c('div',{staticClass:"auction-status"},[_vm._v(_vm._s(_vm.$t('auction.status'))+" : "),_c('span',{staticClass:"status-being"},[_vm._v("Fixed period （ 47:56:30 ）")])]),_vm._v(" "),_c('div',{staticClass:"auction-price"},[_vm._v(_vm._s(_vm.$t('auction.highest'))+" : "+_vm._s(_vm.auctionMsg_alert.maxPrice)+" SGas")])]),_vm._v(" "),_c('div',{staticClass:"wrap-msg"},[_c('div',{staticClass:"my-bid"},[_c('span',[_vm._v(_vm._s(_vm.$t('auction.raisebid'))+" : ")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.alert_myBid),expression:"alert_myBid"}],staticClass:"bid-input",attrs:{"type":"number","placeholder":_vm.$t('auction.enterbid')},domProps:{"value":(_vm.alert_myBid)},on:{"input":[function($event){if($event.target.composing){ return; }_vm.alert_myBid=$event.target.value},_vm.verifBidAmount]}})]),_vm._v(" "),_c('div',{staticClass:"my-bid"},[_vm._v("\n            "+_vm._s(_vm.$t('auction.yourbidmsg'))+" : "),_c('span',{staticClass:"status-ended"},[_vm._v(_vm._s(_vm.myBalanceOfSelling))]),_vm._v(" SGas\n          ")])]),_vm._v(" "),_c('div',{staticClass:"tips-msg"},[_vm._v("\n          "+_vm._s(_vm.$t('auction.tips1'))+"\n        ")]),_vm._v(" "),_c('div',{staticClass:"btn-bid-box"},[(_vm.canAdded)?_c('button',{staticClass:"btn btn-nel btn-big",on:{"click":function($event){_vm.bidDomain()}}},[_vm._v(_vm._s(_vm.$t('btn.bid')))]):_c('button',{staticClass:"btn btn-nel btn-big btn-disable",attrs:{"disabled":"disabled"}},[_vm._v(_vm._s(_vm.$t('btn.bid')))])]),_vm._v(" "),_c('div',{staticClass:"auction-close"},[_c('span',{attrs:{"aria-hidden":"true"},on:{"click":function($event){_vm.auctionShow = !_vm.auctionShow}}},[_vm._v("×")])])])]):_vm._e(),_vm._v(" "),(_vm.alert_TopUp.isShow)?_c('div',{staticClass:"top-up-wrap"},[_c('div',{staticClass:"top-up-box"},[_c('div',{staticClass:"topup-title"},[_c('span',[_vm._v(_vm._s(_vm.$t('auction.topup')))])]),_vm._v(" "),_c('div',{staticClass:"asset-wrap"},[_c('div',{staticClass:"asset-name"},[_vm._v(_vm._s(_vm.$t('auction.asset'))+" :")]),_vm._v(" "),_c('v-selected',{attrs:{"list":_vm.selectList},on:{"selected":_vm.onSelect}}),_vm._v(" "),_c('div',{staticClass:"asset-available"},[_c('span',[_vm._v(_vm._s(_vm.alert_available)+" "+_vm._s(_vm.$t('auction.errmsg3')))])])],1),_vm._v(" "),_c('div',{staticClass:"amount-wrap"},[_c('div',{staticClass:"amount-msg"},[_vm._v(_vm._s(_vm.$t('auction.amount'))+":")]),_vm._v(" "),_c('div',{staticClass:"input-box"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.alert_TopUp.input),expression:"alert_TopUp.input"}],attrs:{"type":"number","placeholder":_vm.$t('auction.amount')},domProps:{"value":(_vm.alert_TopUp.input)},on:{"input":[function($event){if($event.target.composing){ return; }_vm.$set(_vm.alert_TopUp, "input", $event.target.value)},_vm.verifToupAmount]}}),_vm._v(" "),(!_vm.alert_TopUp.watting)?_c('button',{staticClass:"btn btn-nel btn-big",on:{"click":_vm.gasToRecharge}},[_vm._v(_vm._s(_vm.$t('btn.confirm')))]):_c('spinner-wrap')],1),_vm._v(" "),_c('div',{staticClass:"status-ended err-msg"},[_vm._v("\n            "+_vm._s(_vm.$t('auction.errmsg1'))+" "+_vm._s(_vm.alert_available)+" "+_vm._s(_vm.$t('auction.errmsg3'))+".\n          ")])]),_vm._v(" "),_c('div',{staticClass:"topup-tips"},[_vm._v("\n          "+_vm._s(_vm.$t('auction.tipsmsg4'))+"\n        ")]),_vm._v(" "),_c('div',{staticClass:"topup-close",on:{"click":function($event){_vm.alert_TopUp.isShow=!_vm.alert_TopUp.isShow}}},[_c('span',{attrs:{"aria-hidden":"true"}},[_vm._v("×")])])])]):_vm._e(),_vm._v(" "),(_vm.alert_withdraw.isShow)?_c('div',{staticClass:"withdraw-wrap"},[_c('div',{staticClass:"withdraw-box"},[_c('div',{staticClass:"withdraw-title"},[_c('span',[_vm._v(_vm._s(_vm.$t('auction.withdraw')))])]),_vm._v(" "),_c('div',{staticClass:"line-wrap"},[_c('div',{staticClass:"line-msg"},[_vm._v(_vm._s(_vm.$t('auction.to'))+" :")]),_vm._v(" "),_c('div',{staticClass:"line-box"},[_c('input',{staticClass:"readonly-input",attrs:{"type":"text","disabled":""},domProps:{"value":_vm.$t('auction.yourbalance')}})])]),_vm._v(" "),_c('div',{staticClass:"line-wrap"},[_c('div',{staticClass:"line-msg"},[_vm._v(_vm._s(_vm.$t('auction.amount'))+":")]),_vm._v(" "),_c('div',{staticClass:"line-box"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.alert_withdraw.input),expression:"alert_withdraw.input"}],attrs:{"type":"number","placeholder":_vm.$t('auction.amount')},domProps:{"value":(_vm.alert_withdraw.input)},on:{"input":[function($event){if($event.target.composing){ return; }_vm.$set(_vm.alert_withdraw, "input", $event.target.value)},_vm.verifWithdraw]}}),_vm._v(" "),(_vm.alert_withdraw.watting)?_c('spinner-wrap'):_c('button',{staticClass:"btn btn-nel btn-big",on:{"click":_vm.withdraw}},[_vm._v(_vm._s(_vm.$t('btn.confirm')))])],1),_vm._v(" "),_c('div',{staticClass:"status-ended err-msg"},[_vm._v("\n            "+_vm._s(_vm.regBalance)+" SGas "+_vm._s(_vm.$t('auction.errmsg3'))+".\n          ")])]),_vm._v(" "),_c('div',{staticClass:"withdraw-close",on:{"click":function($event){_vm.alert_withdraw.isShow=!_vm.alert_withdraw.isShow}}},[_c('span',{attrs:{"aria-hidden":"true"}},[_vm._v("×")])])])]):_vm._e(),_vm._v(" "),_c('v-toast',{ref:"toast"})],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var bid_neoauction = (esExports);
// CONCATENATED MODULE: ./src/pages/bid/neoauction.vue
function injectStyle (ssrContext) {
  __webpack_require__("WsQ0")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
/* template */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-94ebd6c0"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
...
var AuctionInfo = /** @class */ (function (_super) {
    ...
    function AuctionInfo() {
        ...
        _this.currentpage = 1;
        _this.pagesize = 5;
        _this.session_bid = new storagetool_1.LocalStoreTool("bidSession");
        _this.session_recover = new storagetool_1.LocalStoreTool("recoverSession");
        _this.session_getdomain = new storagetool_1.LocalStoreTool("getDomainSession");
        _this.fee = 0;
        _this.remaining = 0;
    ...
    AuctionInfo.prototype.myBidInput = function ($event) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, importpack_1.tools.nnssell.getSellingStateByDomain(this.item.domain)];
                    case 1:
                        info = _a.sent();
                    ...
                    case 2:
                        res = _a.sent();
                        txid = res["txid"];
                        this.session_getdomain.put(this.item.domain, { txid: txid, method: 1 });
                    ...
                    case 6:
                        res = _a.sent();
                        txid = res["txid"];
                        this.session_getdomain.put(this.item.domain, { txid: txid, method: 2 });
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (txmsg) {
                            ...
                            bidmsg = { addPriceTime: 'Waiting for confirmation', maxBuyer: '', maxPrice: '' };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (res) {
                            ...
                            for (i in res[0].list) {
                                res[0].list[i].addPriceTime = importpack_1.tools.timetool.dateFtt("yyyy/MM/dd hh:mm:ss", new Date(res[0].list[i].addPriceTime * 1000));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, importpack_1.tools.nnssell.addprice(this.item.domain, count)];
                    case 2:
                        res = _a.sent();
                        txid = res.info;
                        amount = this.bidPrice;
                        this.session_bid.put(this.item.domain, { txid: txid, amount: amount }, txid);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (res["txid"]) {
                            txid = res["txid"];
                            this.session_recover.put(this.item.domain, { txid: txid });
    ...
    __decorate([
        vue_property_decorator_1.Prop(),
        __metadata("design:type", Object)
    ], AuctionInfo.prototype, "item", void 0);
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-3a0ede1b"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  myneo_default.a,
