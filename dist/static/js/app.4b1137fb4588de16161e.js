...
var WWW = /** @class */ (function () {
    ...
    /**判断是否获取了NNC */
    WWW.api_hasclaimnnc = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var postdata, result, json, r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        postdata = WWW.makeRpcPostBody("hasClaimNNC", address);
                        return [4 /*yield*/, fetch(WWW.apiaggr, { "method": "post", "body": JSON.stringify(postdata) })];
                    case 1:
                        result = _a.sent();
                        return [4 /*yield*/, result.json()];
     ...
     * 获取测试网NNC
     */
    WWW.api_claimNNC = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var postdata, result, json, r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        postdata = WWW.makeRpcPostBody("claimNNC", address);
                        return [4 /*yield*/, fetch(WWW.apiaggr, { "method": "post", "body": JSON.stringify(postdata) })];
                    case 1:
                        result = _a.sent();
                        return [4 /*yield*/, result.json()];
     ...
     * @param pagesize 页面条数
     */
    WWW.getauctioninfobyaddress = function (address, currentpage, pagesize, root, search) {
        return __awaiter(this, void 0, void 0, function () {
            var postdata, result, json, r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        postdata = WWW.makeRpcPostBody("getauctioninfobyaddress", address, currentpage, pagesize, root, search);
                        return [4 /*yield*/, fetch(WWW.apiaggr, { "method": "post", "body": JSON.stringify(postdata) })];
                    case 1:
                        result = _a.sent();
                        return [4 /*yield*/, result.json()];
...
var SgasTool = /** @class */ (function () {
    ...
    SgasTool.makeMintTokenTransaction = function (transcount) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        script = importpack_1.tools.contract.buildScript(importpack_1.tools.coinTool.id_CGAS, "mintTokens", []);
                        sgasaddr = ThinNeo.Helper.GetAddressFromScriptHash(importpack_1.tools.coinTool.id_CGAS);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    SgasTool.makeRefundTransaction = function (transcount) {
        return __awaiter(this, void 0, void 0, function () {
            var utxos_current, utxos_cgas, nepAddress, gass, cgass, i, item, utxo, tran, cgasRes, feeRes, i_1, scriptHash, sb, txid, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, importpack_1.tools.coinTool.getassets()];
                    case 1:
                    ...
                    case 2:
                        utxos_cgas = _a.sent();
                        nepAddress = ThinNeo.Helper.GetAddressFromScriptHash(importpack_1.tools.coinTool.id_CGAS);
                        ...
                        tran.type = ThinNeo.TransactionType.InvocationTransaction;
                        tran.extdata.script
                            = importpack_1.tools.contract.buildScript(importpack_1.tools.coinTool.id_CGAS, "refund", ["(bytes)" + scriptHash.toHexString()]);
                        //附加鉴证
                        ...
                        tran.AddWitnessScript(new Uint8Array(0), sb.ToArray(), importpack_1.tools.coinTool.id_CGAS.toArray());
                        txid = tran.GetTxid();
...
var Balance = function (resolve) { return __webpack_require__.e/* require */(7).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("v8qo")]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe); };
...
var Transfer = function (resolve) { return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(8)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("Oz3I")]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe); };
...
var Auction = function (resolve) { return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(4)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("jrmo")]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe); };
var MyNeoName = function (resolve) { return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(15)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("ogHy")]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe); };
...
var AuctionTest = function (resolve) { return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(3)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("dtBB")]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe); };
var MyTestName = function (resolve) { return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(12)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("bnm1")]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe); };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e8b02d86_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_wallet_vue__ = __webpack_require__("4ulj");
function injectStyle (ssrContext) {
  __webpack_require__("AGBo")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e8b02d86_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_wallet_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var TaskManager = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _d.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 48];
                        type = _a[_i];
                        if (!taskList.hasOwnProperty(type)) return [3 /*break*/, 47];
                        tasks = taskList[type];
                        _c = parseInt(type);
                        switch (_c) {
                            ...
                            case entity_1.TaskType.requestNNC: return [3 /*break*/, 40];
                            case entity_1.TaskType.bindDomain: return [3 /*break*/, 42];
                            case entity_1.TaskType.delBindDomain: return [3 /*break*/, 44];
                        }
                        return [3 /*break*/, 46];
                    ...
                    case 39:
                        _d.sent();
                        return [3 /*break*/, 47];
                    case 40: return [4 /*yield*/, this.confirm_requestNNC(tasks)];
                    case 41:
                        _d.sent();
                        return [3 /*break*/, 47];
                    case 42: return [4 /*yield*/, this.confirm_bindDomain(tasks)];
                    case 43:
                        _d.sent();
                        return [3 /*break*/, 47];
                    case 44: return [4 /*yield*/, this.confirm_delBindDomain(tasks)];
                    case 45:
                        _d.sent();
                        return [3 /*break*/, 47];
     ...
     * @param tasks
     */
    TaskManager.confirm_requestNNC = function (tasks) {
        return __awaiter(this, void 0, void 0, function () {
            var taskarr, index, task, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        task = tasks[index];
                        if (!(task.state == entity_1.TaskState.watting)) return [3 /*break*/, 3];
                        return [4 /*yield*/, importpack_1.tools.wwwtool.api_hasclaimnnc(task.message.address)];
                    case 2:
                        res = _a.sent();
                        if (res) {
                            if (res[0].code == "3001") //可领取
                             {
                                task.state = entity_1.TaskState.fail;
                                if (entity_1.TaskFunction.getNNCTest)
                                    entity_1.TaskFunction.getNNCTest(0); //可领取
                            }
                            ...
                            else if (res[0].code == "3004") //已领取
                             {
                                task.state = entity_1.TaskState.success;
                                if (entity_1.TaskFunction.getNNCTest)
                                    entity_1.TaskFunction.getNNCTest(1); //已领取
                            }
                            else if (res[0].code == "3003") //正在领取
                             {
                                task.state = entity_1.TaskState.watting;
                                if (entity_1.TaskFunction.getNNCTest)
                                    entity_1.TaskFunction.getNNCTest(2); //已领取
                            }
                        }
                        _a.label = 3;
                    case 3:
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 1];
                    case 5:
                        this.taskStore.put(entity_1.TaskType.requestNNC.toString(), taskarr);
                        return [2 /*return*/];
                }
            });
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_37d2cc14_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_confrim_vue__ = __webpack_require__("WFTm");
function injectStyle (ssrContext) {
  __webpack_require__("0uY/")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-37d2cc14"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__ts_loader_confrim_ts___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_37d2cc14_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_confrim_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4c6eb4cd_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Main_vue__ = __webpack_require__("EkL8");
function injectStyle (ssrContext) {
  __webpack_require__("2ZIe")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4c6eb4cd_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Main_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var CoinTool = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (a in allassets) {
                            ...
                            else if (id == CoinTool.id_CGAS.toString()) {
                                name = "CGAS";
                            }
                            else {
                                for (i in names) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        utxos = _a.sent();
                        assets = {};
                        addr = ThinNeo.Helper.GetAddressFromScriptHash(importpack_1.tools.coinTool.id_CGAS);
    ...
    CoinTool.id_CGAS = Neo.Uint160.parse('74f2dc36a68fdc4682034178eb2220729231db76');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        sb.EmitPushString("transfer"); //参数倒序入
                        sb.EmitAppCall(importpack_1.tools.coinTool.id_CGAS); //nep5脚本
                        ////这个方法是为了在同一笔交易中转账并充值
                        ////当然你也可以分为两笔交易
                        ////插入下述两条语句，能得到txid
                        sb.EmitSysCall("System.ExecutionEngine.GetScriptContainer");
