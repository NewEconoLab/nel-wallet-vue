...
var NeoAuction = /** @class */ (function (_super) {
     ...
     * 查询域名
     */
    NeoAuction.prototype.doSearchDomain = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
...
var NeoaucionData = /** @class */ (function () {
    ...
    /**搜索参与竞拍的域名列表 */
    NeoaucionData.searchBidList = function (address, searchDomain) {
        return __awaiter(this, void 0, void 0, function () {
            var res, arr, list, ids, amounts, i, element, current, balanceOfSelling, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, importpack_1.tools.wwwtool.searchdomainbyaddress(address, searchDomain)];
                    case 1:
                        res = _a.sent();
                        arr = new Array();
                        list = res ? res["list"] : [];
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-de52bbc2"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  exchange_default.a,
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-0a5f09b8"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  myneo_default.a,
