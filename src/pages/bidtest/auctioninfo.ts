...
export default class AuctionInfoTest extends Vue
{
    auctionId: string;
    ...
    async bidDomain()
    {
        ...
        try
        {
            ...
            if (confirmres)
            {
                ...
                let res = await services.auction_test.auctionRaise(this.auctionInfo.id, this.auctionInfo.domain, count, this.rootInfo.register);
                if (!res.err)
