...
export class CoinTool
{
    ...
    static readonly id_CGAS: Neo.Uint160 = Neo.Uint160.parse('74f2dc36a68fdc4682034178eb2220729231db76');
    ...
    static async getavailableutxos(count: number): Promise<{ [id: string]: UTXO[] }>
    {
        ...
        var assets = {};        //对utxo进行归类，并且将count由string转换成 Neo.Fixed8
        var addr = ThinNeo.Helper.GetAddressFromScriptHash(tools.coinTool.id_CGAS);
