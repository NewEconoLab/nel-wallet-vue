...
namespace tools
{
    ...
    {
        static root_test: tools.RootDomainInfo;
        ...
        static async queryDomainInfo(doamin: string)
        {
            ...
            let doamininfo = await NNSTool.getOwnerInfo(nnshash, tools.Consts.baseContract.hexToBytes().reverse());
        ...
        //返回域名详情
        static async getOwnerInfo(domain: Uint8Array, scriptaddress: Uint8Array): Promise<tools.DomainInfo>
        {
            let info: tools.DomainInfo = new tools.DomainInfo();
            var sb = new ThinNeo.ScriptBuilder();
         ...
         * @param scriptaddress 
         */
        static async setResolve(nnshash: Uint8Array, resolverhash: Uint8Array): Promise<tools.Result>
        {
        ...
        static domainStatus: tools.DomainStatus;
        ...
        static initStatus()
        {
            NNSTool.domainStatus = tools.DomainStatus.getStatus() as tools.DomainStatus;
        }
